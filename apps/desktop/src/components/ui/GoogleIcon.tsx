/**
 * Marca "G" de Google, en SVG local (sin CDN ni fuente remota — regla del
 * proyecto). Solo se usa para atribuir el origen real de una reseña, nunca
 * como logo propio ni como si Action estuviera afiliada a Google.
 */
